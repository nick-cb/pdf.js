...
export class RenderingCancelledException extends RenderingCancelledException_base {
    [x: string]: any;
    constructor(msg: any, extraDelay?: number, abortOperatorList?: boolean);
    extraDelay: number;
    abortOperatorList: boolean;
}
...
export class StatTimer {
    ...
    timeEndIfStarted(name: any): boolean;
    add(name: any, start: any, end?: number): void;
    toString(): string;
    #private;
}
