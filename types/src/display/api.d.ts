...
export type DocumentInitParameters = {
    ...
    /**
     * - Log a structured profile of every
     ...
     */
    profileImages?: boolean | undefined;
    /**
...
export class PDFDocumentProxy {
     ...
     */
    saveDocument(printToPDF?: (arg0: Array<object>) => Promise<Uint8Array | null>): Promise<Uint8Array<ArrayBuffer>>;
    /**
