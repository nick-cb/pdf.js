...
class JpxImage extends WasmImage {
  ...
  async decode(bytes, {
    ...
    try {
      ...
      profile?.(succeeded ? `decoder: JPEG2000 / OpenJPEG ${this.decoderType}` : `decoder attempt: JPEG2000 / OpenJPEG ${this.decoderType} (failed)`, start, typeof performance !== "undefined" ? performance.now() : Date.now());
      if (ptr) {
        module._free(ptr);
      }
    }
